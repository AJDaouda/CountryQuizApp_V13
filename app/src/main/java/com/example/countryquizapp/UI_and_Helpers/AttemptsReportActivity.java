...
public class AttemptsReportActivity extends AppCompatActivity implements DatabaseManager.DatabaseListener{
    ...
    public void databaseAllAttemptsListener(List<Attempt> list) {
        ...
        AttemptReportAdapter adapter = new AttemptReportAdapter(attemptListFromDB, this);
